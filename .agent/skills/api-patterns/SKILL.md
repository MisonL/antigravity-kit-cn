---
name: api-patterns
description: API设计原则与决策逻辑。包含 REST vs GraphQL vs tRPC 选择、响应格式、版本控制及分页。
...
- **机制基线**：沿用上游 `.agent/skills/api-patterns/SKILL.md`。
- **Codex 适配**：由适配层映射到 `.agents/skills/api-patterns/SKILL.md`。
