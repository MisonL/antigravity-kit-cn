---
name: nuxt-app
description: Nuxt 4 全栈模板。Vue 3（Vapor）、Pinia、Tailwind v4、Prisma。
---
...
| **Vapor Mode（Vapor 模式）** | 性能优先 | 无需 Virtual DOM（虚拟 DOM，类似 SolidJS）。在 `nuxt.config` 中启用。 |
