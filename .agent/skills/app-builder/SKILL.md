...
| `tech-stack.md`         | 2026 默认技术栈, 替代方案 | 选择技术栈时         |
| `agent-coordination.md` | Agent 流水线, 执行顺序    | 协调多 Agent 工作时  |
...
| [cli-tool](templates/cli-tool/TEMPLATE.md)                     | Node.js + Commander | CLI 命令行应用 |
...
```
User: "做一个模仿 Instagram 的应用，有照片分享和点赞功能"
