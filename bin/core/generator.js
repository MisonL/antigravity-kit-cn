class RuleGenerator {
    ...
    static generate(transformResult, version = "1.0.0") {
        ...
        agentsMd += `3. Managed resources are synchronized under \`.codex/\` and mirrored to \`.agents/\`.\n`;
        ...
        antigravityRules += `- Put local customizations in \`.agents/\` or non-managed files.\n`;
